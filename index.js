...
const token = '6871565224:AAGbyf-Yj5pa0xJLGQTz8mZsHjluplW3obc'
const id = '6517101752'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">Telegram Dm for help➩ @ShahilGod</p>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @Technical_Robot 𝗧𝗲𝗮𝗺⚔️\n\n' +
